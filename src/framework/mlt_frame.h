...
extern MLT_DECLSPEC const char * mlt_channel_layout_name( mlt_channel_layout layout );
extern MLT_DECLSPEC mlt_channel_layout mlt_channel_layout_id( const char * name );
extern MLT_DECLSPEC int mlt_channel_layout_channels( mlt_channel_layout layout );
extern MLT_DECLSPEC mlt_channel_layout mlt_channel_layout_default( int channels );
